...
if($ru==0){
$output="<p>This is a list of released updates for Half-Life, you can download
a few of the old installers but some will need to be searched for.
<br />Most recent mod releases will work with the Steam port of Half-Life.
These are labeled as versions 1.1.1.1 and above (if a mod is WON based but has
Steam support it will say \"Steam-friendly\"). Some of them will have no
background images - you can use 1.1.1.0.
<br />Older modifications(pre-2003) use WON or the CD release of Half-Life.
They will still work with Steam for the most part(however, backgrounds will be
nonexistent and crashes may occur).
<br />Check the requirements of developer, some versions of the engine may
conflict with other versions.</p>
...
"."<br /><p>See also: <a href=\"http://hl.loess.ru/?txt=1111\">Which version &gt;1111 to choose?</a>
";}
elseif($ru==1){
$output="<br /><br /><p>Смотри также: <a href=\"http://hl.loess.ru/?txt=changelog1110\">История изменений &lt;1110</a>
"."<br /><p>Смотри также: <a href=\"http://hl.loess.ru/?txt=1111\">Какую версию &gt;1111 выбрать?</a>
";}
echo($output);
?>
